...
# 1. FIX THE CALCULADORAS DOT BUG
# Remove the stray pagination from the bottom
bad_calc_pagination = '''      </div>
...
good_calc_pagination = '''      </div>
        <div class="pagination" style="height: 60px; display: flex; align-items: center; justify-content: center; gap: 12px; flex-shrink: 0;"><div class="dot active"></div></div>
      </div>

  </div>
</div>'''
if bad_calc_pagination in html:
    html = html.replace(bad_calc_pagination, good_calc_pagination)

# Wait, let's just do it cleanly using regex for the whole end of the file.
html = re.sub(r'      </div>\n        <div class="pagination"[^>]+><div class="dot active"></div></div>\n\n\n  </div>\n</div>',
              r'        <div class="pagination" style="height: 60px; display: flex; align-items: center; justify-content: center; gap: 12px; flex-shrink: 0;"><div class="dot active"></div></div>\n      </div>\n\n  </div>\n</div>', html)

# 2. REFACTOR RAMPAS VIEWS TO USE SEPARATE BOXES
metadata_bar = """<div style="display: flex; align-items: center; gap: 40px; margin-bottom: 24px; padding: 0 16px;">
        ...
        <div class="views-wrapper" data-pages="3" style="flex: 1; min-height: 0; overflow: hidden;">
          <div class="views-track" style="width: 300%; display: flex; height: 100%; transition: transform 0.5s cubic-bezier(0.22, 1, 0.36, 1);">
            ...
            <div class="view" style="width: 33.333%; padding: 0 40px; box-sizing: border-box; height: 100%; display: flex; flex-direction: column;">
              {metadata_bar}
              <hr style="border: 0; border-top: 1px solid #333; margin: 0 16px 24px 16px;">
            ...
            <div class="view" style="width: 33.333%; padding: 0 40px; box-sizing: border-box; height: 100%; display: flex; flex-direction: column;">
              ...
              <div style="flex: 1; overflow-y: auto; display: flex; flex-direction: column; gap: 16px; margin-bottom: 24px; padding-right: 16px;">
                <!-- Step 1 -->
                <div class="card" style="display: flex; align-items: center; padding: 24px; gap: 24px; position: relative;">
                ...
                <!-- Step 2 ACTIVE -->
                <div class="card" style="display: flex; align-items: center; padding: 24px; border: 1px solid #444; gap: 24px; position: relative; box-shadow: 0 4px 20px rgba(0,0,0,0.5);">
              ...
              <!-- Controls -->
              <div style="display: flex; gap: 16px; height: 90px; flex-shrink: 0; padding: 0 16px;">
                <button class="card" style="flex: 1; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px; cursor: pointer; padding: 0; font-size: 14px; font-weight: 700; letter-spacing: 1px;">
                ...
                <button class="card" style="flex: 1; border: 1px solid #ff4444; color: #ff4444; display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 8px; cursor: pointer; padding: 0; font-size: 14px; font-weight: 700; letter-spacing: 1px;">
            ...
            <div class="view" style="width: 33.333%; padding: 0 40px; box-sizing: border-box; height: 100%; display: flex; flex-direction: column;">
              <div class="card" style="flex: 1; min-height: 0; padding: 40px; display: flex; flex-direction: column;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 40px;">
                  ...
                  <button class="card" style="padding: 12px 24px; font-size: 14px; letter-spacing: 2px; display: flex; align-items: center; gap: 8px; cursor: pointer; border-radius: 20px;">
                ...
                <div style="flex: 1; overflow-y: auto; position: relative; padding-left: 20px; padding-right: 16px;">
                  ...
                  <div style="display: flex; gap: 32px; margin-bottom: 24px; position: relative; z-index: 1;">
                    <div style="width: 16px; height: 16px; border-radius: 50%; background: #a855f7; border: 4px solid #1a1a1a; margin-top: 32px; flex-shrink: 0; box-shadow: 0 0 10px #a855f7;"></div>
                    <div class="card" style="flex: 1; padding: 24px; position: relative;">
