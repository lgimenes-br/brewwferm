...
new_header = """
      <!-- HEADER -->
      <div class="header" style="display: flex; justify-content: space-between; align-items: center; padding: 40px 40px 0 40px; margin-bottom: 40px; background: var(--bg-base); z-index: 10;">
