...
menu_items = """
                <!-- BRIX -->
                <div class="app-card" onclick="document.getElementById('calc-menu').style.display='none'; document.getElementById('calc-brix').style.display='flex';" style="height: 180px;">
                ...
                <!-- ABV -->
                <div class="app-card" onclick="document.getElementById('calc-menu').style.display='none'; document.getElementById('calc-abv').style.display='flex';" style="height: 180px;">
                ...
                <!-- CARBONATAÇÃO -->
                <div class="app-card" onclick="document.getElementById('calc-menu').style.display='none'; document.getElementById('calc-carb').style.display='flex';" style="height: 180px;">
                ...
                <!-- TAXA DE LEVEDURA -->
                <div class="app-card" onclick="document.getElementById('calc-menu').style.display='none'; document.getElementById('calc-yeast').style.display='flex';" style="height: 180px;">
                ...
                <!-- DENSIDADE -->
                <div class="app-card" onclick="document.getElementById('calc-menu').style.display='none'; document.getElementById('calc-dens').style.display='flex';" style="height: 180px;">
                ...
                <!-- DENSIMETRO TEMP -->
                <div class="app-card" onclick="document.getElementById('calc-menu').style.display='none'; document.getElementById('calc-temp').style.display='flex';" style="height: 180px;">
...
def make_calc(id_str, title, inputs, results):
    inputs_html = ""
    ...
    return f'''
            <div id="{id_str}" style="display: none; flex-direction: column; height: 100%; width: 100%;">
              <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px;">
                <div style="font-size: 20px; font-weight: 700; color: #FFF; letter-spacing: 1px;">{title}</div>
                <div class="btn-set primary" onclick="document.getElementById('{id_str}').style.display='none'; document.getElementById('calc-menu').style.display='grid';" style="padding: 12px 24px; font-size: 14px;">
...
calc1 = make_calc("calc-brix", "Correção de Refratômetro (Brix)", {"OG (BRIX)": "12.0", "FG (BRIX)": "6.0"}, {"FG CORRIGIDA (SG)": "1.011", "ABV ESTIMADO": "5.4%"})
calc2 = make_calc("calc-abv", "Cálculo de ABV e Atenuação", {"OG (SG)": "1.050", "FG (SG)": "1.010"}, {"ABV": "5.2%", "ATENUAÇÃO": "80%"})
calc3 = make_calc("calc-carb", "Carbonatação Forçada", {"VOLUMES CO2": "2.5", "TEMP (°C)": "4.0"}, {"PRESSÃO ALVO (PSI)": "11.2", "AÇÚCAR (g/L)": "5.6"})
calc4 = make_calc("calc-yeast", "Taxa de Levedura", {"LITROS": "20", "OG (SG)": "1.050", "TAXA": "0.75"}, {"CÉLULAS (Bilhões)": "180", "PACOTES (11g)": "2"})
calc5 = make_calc("calc-dens", "Ajuste de Densidade", {"LITROS ATUAL": "20", "SG ATUAL": "1.040", "SG ALVO": "1.050"}, {"VOLUME FINAL (L)": "16.0", "FERVER/ÁGUA": "-4.0 L"})
calc6 = make_calc("calc-temp", "Correção Temp. Densímetro", {"SG LIDA": "1.045", "TEMP AMOSTRA": "30°C", "TEMP CALIB.": "20°C"}, {"SG CORRIGIDA": "1.048"})

new_html = f'''<div class="app-container" id="app-calculadoras" style="display: none; position: relative;">
        <div style="flex: 1; min-height: 0; overflow-y: auto; padding: 0 40px; box-sizing: border-box; width: 100%;">
            
          <!-- MENU DE CALCULADORAS -->
          <div id="calc-menu" style="padding-bottom: 40px; display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; align-items: start;">
{menu_items}
          </div>
