...
import { Plus, Calendar, X, MessageSquareText } from 'lucide-react';
...
export const FermentationTimeline: React.FC<FermentationTimelineProps> = ({ events, onAddEvent, onRemoveEvent }) => {
  ...
  const sortedEvents = [...safeEvents].sort((a, b) => new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime());
