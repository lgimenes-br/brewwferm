...
export const CarbonationCalculator: React.FC = () => {
    ...
    const beerStyles = [
        ...
        { name: 'Stout / Porter', min: 1.5, max: 2.2 },
        { name: 'English Bitter', min: 0.8, max: 1.3 },
        { name: 'German Pilsner', min: 2.4, max: 2.8 },
        { name: 'Belgian Tripel', min: 1.9, max: 2.4 },
        { name: 'Wheat Beer / Weizen', min: 3.6, max: 4.5 },
